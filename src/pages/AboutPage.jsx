    ...
    <motion.div variants={SECTION_VARIANTS} initial="hidden" animate="visible" className="space-y-12">
      <GlassCard className="p-8 lg:p-10">
        ...
        <div className="space-y-6 text-da-silver/80 leading-relaxed">
          <p>
            I study computer science at UT Dallas — expected graduation May 2027 — with a focus on full-stack development and scalable systems. Currently a Software Development Engineer Intern at Amazon, building customer-facing features for Amazon Photos that reach 200+ million Prime members using React, TypeScript, and Redux Toolkit. I gravitate toward problems that require rigor, ethics, and operational calm: from production-scale front-end architecture to RESTful APIs, geospatial platforms, and automation tools that stay invisible when they need to.
          </p>
          <p>
