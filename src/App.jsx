...
const SHOOTING_STAR_MIN_DELAY = 3000 // Minimum spawn delay in milliseconds (3 seconds)
const SHOOTING_STAR_MAX_DELAY = 8000 // Maximum spawn delay in milliseconds (8 seconds)
